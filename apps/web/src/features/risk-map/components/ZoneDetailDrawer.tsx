  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate="visible"
        exit="exit"
        className="fixed top-14 right-0 bottom-0 z-40 w-full sm:w-[440px] bg-white border-l border-slate-200 shadow-xl flex flex-col font-sans"
      >
        {/* Drawer Header */}
        <div className="p-4 border-b border-slate-200 bg-slate-50/80 flex items-start justify-between gap-3 shrink-0">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] font-mono-data font-bold text-blue-600 uppercase bg-blue-50 px-2 py-0.5 rounded border border-blue-200">
                {zone.id}
              </span>
            ...
            <p className="text-xs text-slate-500 font-medium mt-0.5">
              {zone.district}, {zone.state} · Western Ghats Basin Sector
            </p>
          </div>
          <IconButton
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {/* 1. Risk Score & Severity Gauge */}
          <Card className="p-3.5 bg-white border-slate-200 shadow-2xs space-y-3">
          ...
          {/* 2. Deterministic Risk Driver Breakdown */}
          <Card className="p-3.5 bg-white border-slate-200 shadow-2xs space-y-2.5">
            ...
            <div className="space-y-2 text-xs">
              ...
              <div>
                <div className="flex justify-between text-slate-700 font-semibold mb-1">
                  <span>Terrain Slope Steepness ({zone.slope.toFixed(1)}°)</span>
              ...
              <div>
                <div className="flex justify-between text-slate-700 font-semibold mb-1">
                  <span>Soil Moisture Pore Pressure</span>
              ...
              <div>
                <div className="flex justify-between text-slate-700 font-semibold mb-1">
                  <span>Historical Landslide Scar Buffer</span>
                  <span className="font-mono-data text-slate-600">15% Weight</span>
                </div>
                <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
          ...
          {/* 3. Physical Telemetry & Geotechnical Attributes */}
          <Card className="p-3.5 bg-white border-slate-200 shadow-2xs space-y-2.5">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="p-2 bg-slate-50 rounded-[6px] border border-slate-100 space-y-0.5">
              ...
              <div className="p-2 bg-slate-50 rounded-[6px] border border-slate-100 space-y-0.5">
                <div className="text-[10px] text-slate-400 font-medium flex items-center gap-1">
                  <Droplets className="w-3.5 h-3.5 text-indigo-600" /> Soil Sat.
                </div>
              ...
              <div className="p-2 bg-slate-50 rounded-[6px] border border-slate-100 space-y-0.5">
                <div className="text-[10px] text-slate-400 font-medium flex items-center gap-1">
                  <Mountain className="w-3.5 h-3.5 text-amber-600" /> Slope
                </div>
                <div className="text-sm font-bold font-mono-data text-slate-900">
            ...
            <div className="text-xs text-slate-600 bg-slate-50 p-2 rounded-[4px] border border-slate-100 leading-relaxed">
          ...
          {/* 4. Caine (1980) Threshold Stability Curve */}
          <Card className="p-3.5 bg-white border-slate-200 shadow-2xs space-y-2">
          ...
          {/* 5. Situation Brief (Structured Evidence Summary) */}
          <Card className="p-3.5 bg-blue-50/60 border-blue-200 shadow-2xs space-y-2 text-xs">
            ...
            <div className="text-[10px] text-slate-400 font-mono-data pt-0.5">
              Generated from current telemetry & model evidence.
            </div>
          </Card>

          {/* 6. Active Alert Status & Operator Triage Action */}
          {associatedAlert && (
            <Card
              className={`p-3.5 shadow-2xs space-y-2.5 text-xs ${
                isAlertActive
            ...
            >
              ...
              <p className="text-slate-700 leading-snug text-[11px]">{associatedAlert.reason}</p>
              ...
              {isAlertActive ? (
                ...
                <div className="text-[10px] font-mono-data text-emerald-700 font-semibold flex items-center gap-1">
          ...
          {/* 7. Connected Sensor Node Status */}
          <div className="bg-slate-50 p-3 rounded-[6px] border border-slate-200 space-y-1.5 text-xs">
